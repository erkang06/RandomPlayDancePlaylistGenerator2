/*//GEN-FIRST:event_btnAddFolderActionPerformed
 * Click nbfs://nbhost/SystemFileSystem/Templates/Licenses/license-default.txt to change this license//GEN-LAST:event_btnAddFolderActionPerformed
...
public class MainFrameFlatLaf extends javax.swing.JFrame {
    ...
    // playlist functions
    private void btnAddFolderActionPerformed(java.awt.event.ActionEvent evt) {                                             
    ...
    // countdown functions
    private void btnCountdownAddActionPerformed(java.awt.event.ActionEvent evt) {                                                
        int returnVal = fc.showOpenDialog(MainFrameFlatLaf.this);
        if (returnVal == JFileChooser.APPROVE_OPTION) {
    ...
    private void btnCountdownDeleteActionPerformed(java.awt.event.ActionEvent evt) {                                                   
